...
|---|---|---|
| 🔴 สูง | ขยับทั้งตลาด — มีเตือนล่วงหน้า | FOMC, CPI, Non-farm, Core PCE, GDP Advance, งบ AAPL/MSFT/NVDA/GOOGL/AMZN/META/AVGO/TSLA, หุ้นขยับจริง ≥ 5% |
| 🟡 กลาง | ขยับกลุ่มอุตสาหกรรม/หุ้นใหญ่ | ISM PMI (ผลิต/บริการ), PPI, Retail Sales, JOLTS, ECI, GDP ครั้งที่ 2–3, FOMC Minutes, งบหุ้นใหญ่ตัวอื่น, วันที่มีงบ ≥ 20 บริษัท, หุ้นขยับจริง 2–5% |
| 🟢 ต่ำ | ผลเฉพาะตัว | Jobless Claims รายสัปดาห์, วันที่มีงบน้อย, หุ้นขยับจริง < 2% |
...
| ตัวเลขเศรษฐกิจ: CPI, Non-farm, Core PCE, GDP, PPI, Retail Sales, JOLTS, ECI, ISM PMI, Jobless Claims, FOMC Minutes | `🔴 CPI เงินเฟ้อ (Sep 2026)` (🔴 เตือนก่อน 15 นาที) | 19:30–22:00 |
...
## อัปเดตตารางตัวเลขเศรษฐกิจ (ปีละครั้ง)

วันประกาศ CPI / NFP / PCE / GDP / PPI / Retail Sales / JOLTS / ECI อยู่ใน `macro_events.py` (ตอนนี้มีถึงสิ้นปี 2026)
เมื่อตารางใกล้หมด ปฏิทินจะมี event `⚠️ เพิ่มวันประกาศ ... ปีถัดไป` ขึ้นมาเตือน พร้อมลิงก์ไปหน้าตารางทางการ
ISM PMI, Jobless Claims, FOMC Minutes คำนวณจากกฎอัตโนมัติ ไม่ต้องอัปเดต (แต่ต้องเพิ่มวันหยุดสหรัฐใน `US_HOLIDAYS` ปีละครั้ง)
