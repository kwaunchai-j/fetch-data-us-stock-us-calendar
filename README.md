...
ถ้าหุ้นใหญ่ขยับเกิน ±3% หลังประกาศงบ สคริปต์จะดึง **พาดหัวข่าว 3 ข่าวล่าสุด + ลิงก์** มาใส่ไว้ในโน้ตของ event นั้น
...
- `BIG_MOVE_PCT` — เกณฑ์ % ที่จะดึงข่าวมาแปะ (ค่าเริ่มต้น 3)
